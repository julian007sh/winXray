...
# winXray 
winXray[:loud_sound:](http://dict.youdao.com/dictvoice?audio=winxray&type=2) 是最简洁轻快的 [V2Ray、Shadowsocks、Trojan](https://github.com/v2fly/v2ray-core) 通用客户端（Windows系统），秒速自动发现最快服务器( 有利于避免服务器 )，连接异常秒速智能切换，订阅服务器异常自动刷新订阅，提供一键自动部署服务端工具。 
